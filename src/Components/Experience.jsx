        ...
        <div className="flex-1 ">
          <div className="relative space-y-1 border-l-2 p-8 text-left">
            ...
            <p className="text-sm text-gray-600">
              ...
              perspiciatis accusamus ipsa repellat nihil, reprehenderit
              asperiores, saepe placeat incidunt libero dolor? Minus aspernatur
              animi hic illo voluptate dolorem eius saepe?
            </p>
